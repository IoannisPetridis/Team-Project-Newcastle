    ...
    */
    class System
    {
      ...
      public:
		...
		//FMOD_RESULT F_API set3DListenerAttributes(int listener, const Vector3 *pos, const Vector3 *vel, const Vector3 *forward, const Vector3 *up);
		...
		//FMOD_RESULT F_API get3DListenerAttributes(int listener, Vector3 *pos, Vector3 *vel, Vector3 *forward, Vector3 *up);
    ...
    */
    class ChannelControl
    {
      ...
      public:
		...
		//FMOD_RESULT F_API set3DAttributes(const Vector3 *pos, const Vector3 *vel, const Vector3 *alt_pan_pos = 0);
        FMOD_RESULT F_API get3DAttributes        (FMOD_VECTOR *pos, FMOD_VECTOR *vel, FMOD_VECTOR *alt_pan_pos = 0);
		//FMOD_RESULT F_API get3DAttributes(Vector3 *pos, Vector3 *vel, Vector3 *alt_pan_pos = 0);
    ...
    */
    class Reverb3D
    {
      ...
      public:
		...
		//FMOD_RESULT F_API set3DAttributes(const Vector3 *position, float mindistance, float maxdistance);
		//FMOD_RESULT F_API get3DAttributes(Vector3 *position, float *mindistance,float *maxdistance);

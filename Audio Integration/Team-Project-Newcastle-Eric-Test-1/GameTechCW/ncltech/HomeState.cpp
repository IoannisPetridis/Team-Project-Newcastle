...
void HomeState::ForceCalculator(ArbitraryAI* Arb) { //here is where you would put the logic behind the state
...
void HomeState::CheckTriggers(ArbitraryAI* Arb) {
	...
	//	newState = 2;//guard state
	//	Goalie->SetState(newState);
	//}

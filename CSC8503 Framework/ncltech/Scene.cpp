...
void Scene::RenderScene()
{
	...
	//SetCurrentShader(skyboxShader);//set skyboxShader to be currentShader
...
void Scene::BuildScreenFBO()
{
	...
	glTexImage2DMultisample(GL_TEXTURE_2D_MULTISAMPLE, 4, GL_DEPTH24_STENCIL8, width, height, GL_FALSE);
	//disable the shadow

...
#define DEBUGDRAW_CONSTRAINTS			FALSE
#define DEBUGDRAW_MANIFOLDS				FALSE
#define DEBUGDRAW_COLLISIONVOLUMES		FALSE
#define DEBUGDRAW_OCTREE TRUE
#define DEBUGDRAW_OUTOFBOX FALSE
...
public:
	...
	//void moveAI(GameObject* obj, Vector3 des);

	static bool showCollision;
	static bool showConstraints;
	static bool showManifolds;
	static bool showOctree;
	static bool showWake;

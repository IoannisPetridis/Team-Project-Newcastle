...
public:
	...
	static Mesh* AI()			{ return m_pAI; }
	static Mesh* Tardis()		{ return m_pTardis; }
	static Mesh* EmptyBox()		{ return m_EmptyBox; }
	static Mesh* Torus()		{ return m_pTorus; }
	static Mesh* Piramid()		{ return m_pPiramid; }
	static Mesh* Batman()		{ return m_pBatman; }
...
protected:
	...
	static Mesh* m_EmptyBox;
	static Mesh* m_pTorus;
	static Mesh* m_pPiramid;
	static Mesh* m_pAI;
	static Mesh* m_pBatman;
	static GLuint m_CheckerboardTex;
	static GLuint m_textureForSphere;
	static GLuint m_textureForAI;
	static GLuint m_textureBrick;
};
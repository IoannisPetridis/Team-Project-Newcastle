...
void ActionHandler::ControllerHandle_Force(SimpleMeshObject* P, KeyboardKeys key, Vector3 force, float& timer) {	
...
void ActionHandler::ControllerHandle_Ori(SimpleMeshObject* P, KeyboardKeys key, Vector3 Axis, float degree) {
	if (Window::GetKeyboard()->KeyHeld(key)) {

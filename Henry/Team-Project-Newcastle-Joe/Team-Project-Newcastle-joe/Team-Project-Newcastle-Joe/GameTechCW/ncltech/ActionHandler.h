...
public:
	...
	void ControllerHandle_Force(SimpleMeshObject* P, KeyboardKeys key, Vector3 force, float& timer);
	void ControllerHandle_Torque(SimpleMeshObject* P, KeyboardKeys key, Vector3 force, float& timer);
	void ControllerHandle_Ori(SimpleMeshObject* P, KeyboardKeys key, Vector3 Axis, float degree);

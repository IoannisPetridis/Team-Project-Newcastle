...
public:
	...
	*/
	...
	//type of particle
	void BallHighlightLine();
	void CrashSpark();

	void	TrigleOnOff()	{ isOn = !isOn; }
	...
	*/
	Vector3	GetParticleVariance()				{return particleVariance;}
	void	SetParticleVariance(Vector3 variance) { particleVariance = variance; }
